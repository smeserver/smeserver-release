# $Id: smeserver-release.spec,v 1.13 2010/03/04 18:11:35 slords Exp $

Summary: SME Server release file
Name: smeserver-release
%define version 7.5
%define release 0.rc1
%define displayversion %{version}rc1
Version: %{version}
...
%changelog
* Thu Mar 4 2010 Shad L. Lords <slords@mail.com> 7.5-0.rc1
- Update for rc1 releases of 7.5

* Wed Oct 28 2009 Shad L. Lords <slords@mail.com> 7.5-0.beta1
- Update for beta1 releases of 7.5

* Mon Nov 17 2008 Shad L. Lords <slords@mail.com> 7.4-1
- Update for releases of 7.4

* Mon Jul 7 2008 Shad L. Lords <slords@mail.com> 7.4-0
- Update for beta releases of 7.4

* Tue Jan 1 2008 Shad L. Lords <slords@mail.com> 7.3-1
- Update for releases of 7.3

* Tue Dec 11 2007 Shad L. Lords <slords@mail.com> 7.3-0
- Update for beta releases of 7.3
...
* Tue Nov 28 2006 Gordon Rowell <gordonr@gormand.com.au> 7.1alpha1-01
- Bump to 7.1alpha1
